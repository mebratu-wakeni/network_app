/**
 * Default chart of accounts provisioned for every new tenant.
 * Moved here (from db/seeds/seed_chart_of_accounts.js) because chart_of_accounts
 * is now a tenant-scoped table -- this data must be inserted per-tenant, not once
 * globally at migration time.
 */
